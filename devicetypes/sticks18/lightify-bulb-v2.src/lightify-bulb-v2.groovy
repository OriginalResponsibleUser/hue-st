...
metadata {
	...
	tiles (scale: 2) {
        ...
        controlTile("colorSliderControl", "device.colorTemp", "slider", height: 2, width: 4, range: "(2700..6500)") {
			state "colorTemp", action:"setColorTemp"
		}
		valueTile("kelvin", "device.kelvin", decoration: "flat") {
        ...
        standardTile("color5k", "device.color5k", width: 2, height: 2, decoration: "flat") {
        	state "default", label:'5K', action:"color5k", icon:"st.secondary.refresh"
    	}

		main(["switch"])
		details(["switch", "bulbTemp", "refresh", "levelSliderControl", "level", "colorSliderControl", "kelvin", "color5k"])
	}
}
